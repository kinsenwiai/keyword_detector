...
class IndicLID():
    ...
    def __init__(self, input_threshold = 0.5, roman_lid_threshold = 0.6):
        ...
        self.IndicLID_FTN_path = '/home/users/kinjals/work_dir/models/indiclid-ftn/model_baseline_roman.bin'
        self.IndicLID_FTR_path = '/home/users/kinjals/work_dir/models/indiclid-ftr/model_baseline_roman.bin'
        self.IndicLID_BERT_path = '/home/users/kinjals/work_dir/models/indiclid-bert/basline_nn_simple.pt'
